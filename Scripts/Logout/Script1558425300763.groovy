...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Logout - CodeCanvas Greenfox Jira/strong_You are now logged out Any automatic login has also been stopped'), 
