...
WebUI.verifyElementText(findTestObject('Assignee/assignee_val'), 'Unassigned')

WebUI.refresh()

WebUI.click(findTestObject('Assignee/assignee_btn'))

WebUI.click(findTestObject('Assignee/assignToMe_btn'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Assignee/assignee_dlg_assign_btn'))

WebUI.verifyElementText(findTestObject('Assignee/assignee_val'), 'User5')
