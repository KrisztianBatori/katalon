...
WebUI.sendKeys(findTestObject('Assignee/assignee_fld'), 'user4')

WebUI.click(findTestObject('Assignee/assignee_dlg_assign_btn'))

not_run: WebUI.click(findTestObject('Assignee/assigneeCancel_btn'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Assignee/assignee_val'), 'User4')
